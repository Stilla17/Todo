    ...
    return (
        <div className="max-w-[953px] mx-auto">
            <div className="flex items-center justify-between mt-[50px]">
                <h1 className="text-5xl font-bold">PLANS DAY</h1>
                <form>
                    <input
                        type="text"
                        placeholder="Search"
                        className="bg-[#DEF7E5] w-[277px] h-[46px] pl-[20px] flex items-center"
                    />
                </form>

                <label className="inline-flex items-center relative">
                    <input className="peer hidden" id="toggle" type="checkbox" />
                    <div className="relative w-[110px] h-[50px] bg-white peer-checked:bg-zinc-500 rounded-full 
                    ...
                    <svg
                        ...
                        className="fill-amber-600 peer-checked:opacity-60 absolute w-6 h-6 left-[13px]"
                    >
            ...
            <button className="bg-green-600 text-white font-bold px-[20px] py-[10px] rounded-md mt-[50px] ml-auto block">
                Add Plans +
            </button>
        </div>
    );
