...
const Casino = () => {
    ...
    return (
        <div className='flex p-4 bg-green-700 h-[100%] text-white rounded-xl'>
            <Rulette />
            <div className="">
                ...
                <div className="ml-16 mt-2 w-1/2 grid grid-cols-13 text-sm text-white  font-semibold">
                    ...
                    <div className="col-span-4 box`rder w-[160px] border-white text-white p-2 rounded text-center">2nd 12</div>
