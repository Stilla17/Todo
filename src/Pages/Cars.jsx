    ...
    <>
        <details className="mb-[10px]">
            ...
            <form onSubmit={handleSubmit(onSubmit)} className="w-full">
             ...
             <input type="radio" value={PaynetMrthod} /><label>Karta</label><br />
             <input type="radio" value={PaynetMrthod} /><label>Naxt</label><br />
             <input type="radio" value={PaynetMrthod} /><label>Nasiya</label>
             </div> */}
